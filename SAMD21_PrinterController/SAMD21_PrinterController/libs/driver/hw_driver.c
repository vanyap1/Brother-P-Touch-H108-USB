...
void EXT_SPI_init(void)
{
	...
	gpio_set_pin_direction(TH_LATCH, GPIO_DIRECTION_OUT);
	gpio_set_pin_function(TH_LATCH, GPIO_PIN_FUNCTION_OFF);
	
	gpio_set_pin_level(TH_EXPO, false);
	gpio_set_pin_direction(TH_EXPO, GPIO_DIRECTION_OUT);
	gpio_set_pin_function(TH_EXPO, GPIO_PIN_FUNCTION_OFF);
	
	gpio_set_pin_level(TH_MOT, false);
	gpio_set_pin_direction(TH_MOT, GPIO_DIRECTION_OUT);
	gpio_set_pin_function(TH_MOT, GPIO_PIN_FUNCTION_OFF);
