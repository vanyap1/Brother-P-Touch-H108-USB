...
//printer head
#define TH_LATCH GPIO(GPIO_PORTA, 19)	//LATCH
#define TH_EXPO GPIO(GPIO_PORTA, 15)	//Exposition
#define TH_MOT GPIO(GPIO_PORTA, 14)	    //Tape motor
...
#define VFD_RST GPIO(GPIO_PORTA, 7)		// IO2
